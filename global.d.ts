// Modified from node_modules/sequelize-auto/types/types.d.ts
declare module "sequelize-auto/lib/types" {
  type ColumnDescription = import("sequelize/types/index").ColumnDescription;
  type Dialect = import("sequelize/types/index").Dialect;
  type FKSpec = import("sequelize-auto").FKSpec;
  ...
  export function qNameSplit(qname: string): (string | null)[];
  ...
  export type LangOption = "es5" | "es6" | "esm" | "ts";
  /** "c" camelCase |
   * "l" lower_case |
   * "o" original (db) |
   * "p" PascalCase |
   ...
   * "u" UPPER_CASE
   */
  export type CaseFileOption = "k" | CaseOption;
